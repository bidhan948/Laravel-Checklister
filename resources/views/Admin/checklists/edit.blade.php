            ...
            <div class="row">
                <div class="col-sm-12 ">
                        ...
                        <form action="{{ route('admin.checklist_groups.checklists.update', [$checklistGroup, $checklist]) }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('name') is-invalid @enderror" id="inputSuccess1" type="text" name="name" value="{{ $checklist->name }}">
                                    @error('name')
                    ...
                    <form action="{{ route('admin.checklist_groups.checklists.destroy', [$checklistGroup, $checklist]) }}" method="post">
                        ...
                        @method('DELETE')
                        <div class="form-group">
                            <button class="btn btn-danger" type="submit" onclick="return confirm('{{ __('Are you Sure you want to delete this Checklist?') }}')">
                            ...
                            <table class="table table-responsive-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><a href="{{ route('admin.checklists.tasks.edit', [$checklist,$task]) }}" class="btn btn-success">Edit</a></td>
                                        <td class="text-center">
                                            <form action="{{ route('admin.checklists.tasks.destroy', [$checklist,$task]) }}" method="post">
                                                @csrf
                                                @method('DELETE')
                                                <div class="form-group">
                                                    <button class="btn btn-danger" type="submit" onclick="return confirm('{{ __('Are you Sure you want to delete this ?') }}')">
                    ...
                    <div class="card my-5">
                        ...
                        <form action="{{ route('admin.checklists.tasks.store', [$checklist]) }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <label class="form-col-form-label" for="inputSuccess1">{{ __('Task name') }}</label>
                                ...
                                <div class="form-group">
                                    <label class="form-col-form-label" for="inputSuccess1">{{ __('Task description') }}</label>
                                    <textarea class="form-control @error('desc') is-invalid @enderror" id="inputSuccess1"
                                     type="text" name="desc">{{old('desc')}}</textarea>
                                    @error('desc')
                                    <p class="p-1 text-danger"> {{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="card-footer">
                                    <button class="btn btn-primary" type="submit" style="width: 7%;">{{ __('Save ') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
